...
class RaseProvider with ChangeNotifier {
  static String? _baseUrl;
  String _endpoint = "api/Rasa";
  ...
  Future<SearchResult<Rasa>> get({dynamic filter}) async {
    ...
    if (isValidResponse(response)) {
      ...
      var result = SearchResult<Rasa>();
      result.totalItems = data['totalItems'];

      for (var item in data['data']) {
        result.data.add(Rasa.fromJson(item));
      }
  ...
  Future<Rasa> getId(int id) async {
